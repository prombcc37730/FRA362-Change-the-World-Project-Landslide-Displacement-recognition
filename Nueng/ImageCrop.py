...
def crop_images_interactive(image_paths, scale=0.3, show_result=True):
    """
    ...
    Usage:
        ...
        cropped, coords, idx = crop_images_interactive(paths)
    """
    ...
    def mouse_callback(event, x, y, flags, param):
        ...
        if event == cv2.EVENT_LBUTTONDOWN:
            ...
            if orig_x1 > orig_x0 and orig_y1 > orig_y0:
                state['cropped'] = current_image[orig_y0:orig_y1, orig_x0:orig_x1].copy()
...
if __name__ == "__main__":
    ...
    cropped, coords, image_idx = crop_images_interactive(paths, scale=0.3)
